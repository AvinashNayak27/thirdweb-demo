const contractAddress = "0xCBEC83B4A5aBA99306224c23f893AD6f1Cc4b24D";
const abi = [
  ...
  {
    inputs: [{ internalType: "string", name: "color", type: "string" }],
    name: "getColorData",
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "nameChangeCount", type: "uint256" },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string[]", name: "newNames", type: "string[]" },
    ],
